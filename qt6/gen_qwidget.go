...
func (this *QWidgetData) Winid() uintptr {
	return (uintptr)(C.QWidgetData_winid(this.h))
}

func (this *QWidgetData) SetWinid(winid uintptr) {
	C.QWidgetData_setWinid(this.h, (C.uintptr_t)(winid))
}

func (this *QWidgetData) WidgetAttributes() uint {
	return (uint)(C.QWidgetData_widgetAttributes(this.h))
}

func (this *QWidgetData) SetWidgetAttributes(widget_attributes uint) {
	C.QWidgetData_setWidgetAttributes(this.h, (C.uint)(widget_attributes))
}

func (this *QWidgetData) WindowFlags() WindowType {
	return (WindowType)(C.QWidgetData_windowFlags(this.h))
}

func (this *QWidgetData) SetWindowFlags(window_flags WindowType) {
	C.QWidgetData_setWindowFlags(this.h, (C.int)(window_flags))
}

func (this *QWidgetData) WindowState() uint {
	return (uint)(C.QWidgetData_windowState(this.h))
}

func (this *QWidgetData) SetWindowState(window_state uint) {
	C.QWidgetData_setWindowState(this.h, (C.uint)(window_state))
}

func (this *QWidgetData) FocusPolicy() uint {
	return (uint)(C.QWidgetData_focusPolicy(this.h))
}

func (this *QWidgetData) SetFocusPolicy(focus_policy uint) {
	C.QWidgetData_setFocusPolicy(this.h, (C.uint)(focus_policy))
}

func (this *QWidgetData) SizehintForced() uint {
	return (uint)(C.QWidgetData_sizehintForced(this.h))
}

func (this *QWidgetData) SetSizehintForced(sizehint_forced uint) {
	C.QWidgetData_setSizehintForced(this.h, (C.uint)(sizehint_forced))
}

func (this *QWidgetData) IsClosing() uint {
	return (uint)(C.QWidgetData_isClosing(this.h))
}

func (this *QWidgetData) SetIsClosing(is_closing uint) {
	C.QWidgetData_setIsClosing(this.h, (C.uint)(is_closing))
}

func (this *QWidgetData) InShow() uint {
	return (uint)(C.QWidgetData_inShow(this.h))
}

func (this *QWidgetData) SetInShow(in_show uint) {
	C.QWidgetData_setInShow(this.h, (C.uint)(in_show))
}

func (this *QWidgetData) InSetWindowState() uint {
	return (uint)(C.QWidgetData_inSetWindowState(this.h))
}

func (this *QWidgetData) SetInSetWindowState(in_set_window_state uint) {
	C.QWidgetData_setInSetWindowState(this.h, (C.uint)(in_set_window_state))
}

func (this *QWidgetData) FstrutDirty() uint {
	return (uint)(C.QWidgetData_fstrutDirty(this.h))
}

func (this *QWidgetData) SetFstrutDirty(fstrut_dirty uint) {
	C.QWidgetData_setFstrutDirty(this.h, (C.uint)(fstrut_dirty))
}

func (this *QWidgetData) ContextMenuPolicy() uint {
	return (uint)(C.QWidgetData_contextMenuPolicy(this.h))
}

func (this *QWidgetData) SetContextMenuPolicy(context_menu_policy uint) {
	C.QWidgetData_setContextMenuPolicy(this.h, (C.uint)(context_menu_policy))
}

func (this *QWidgetData) WindowModality() uint {
	return (uint)(C.QWidgetData_windowModality(this.h))
}

func (this *QWidgetData) SetWindowModality(window_modality uint) {
	C.QWidgetData_setWindowModality(this.h, (C.uint)(window_modality))
}

func (this *QWidgetData) InDestructor() uint {
	return (uint)(C.QWidgetData_inDestructor(this.h))
}

func (this *QWidgetData) SetInDestructor(in_destructor uint) {
	C.QWidgetData_setInDestructor(this.h, (C.uint)(in_destructor))
}

func (this *QWidgetData) Unused() uint {
	return (uint)(C.QWidgetData_unused(this.h))
}

func (this *QWidgetData) SetUnused(unused uint) {
	C.QWidgetData_setUnused(this.h, (C.uint)(unused))
}

func (this *QWidgetData) Crect() *QRect {
	crect_goptr := newQRect(C.QWidgetData_crect(this.h))
	crect_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return crect_goptr
}

func (this *QWidgetData) SetCrect(crect QRect) {
	C.QWidgetData_setCrect(this.h, crect.cPointer())
}

func (this *QWidgetData) Pal() *QPalette {
	pal_goptr := newQPalette(C.QWidgetData_pal(this.h))
	pal_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return pal_goptr
}

func (this *QWidgetData) SetPal(pal QPalette) {
	C.QWidgetData_setPal(this.h, pal.cPointer())
}

func (this *QWidgetData) Fnt() *QFont {
	fnt_goptr := newQFont(C.QWidgetData_fnt(this.h))
	fnt_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return fnt_goptr
}

func (this *QWidgetData) SetFnt(fnt QFont) {
	C.QWidgetData_setFnt(this.h, fnt.cPointer())
}

func (this *QWidgetData) Wrect() *QRect {
	wrect_goptr := newQRect(C.QWidgetData_wrect(this.h))
	wrect_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return wrect_goptr
}

func (this *QWidgetData) SetWrect(wrect QRect) {
	C.QWidgetData_setWrect(this.h, wrect.cPointer())
}

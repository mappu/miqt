...
func (this *QUdpSocket) callVirtualBase_SetSocketDescriptor(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt6.QIODeviceBase__OpenModeFlag) bool {
...
func (this *QUdpSocket) OnSetSocketDescriptor(slot func(super func(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt6.QIODeviceBase__OpenModeFlag) bool, socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt6.QIODeviceBase__OpenModeFlag) bool) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}

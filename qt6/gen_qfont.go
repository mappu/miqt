...
func NewQFont3(families []string) *QFont {
	...
	C.QFont_new3(families_ma, &outptr_QFont)
	ret := newQFont(outptr_QFont)
	ret.isSubclass = true
	return ret
}
...
func NewQFont9(families []string, pointSize int) *QFont {
	...
	C.QFont_new9(families_ma, (C.int)(pointSize), &outptr_QFont)
	ret := newQFont(outptr_QFont)
	ret.isSubclass = true
	return ret
}
...
func NewQFont10(families []string, pointSize int, weight int) *QFont {
	...
	C.QFont_new10(families_ma, (C.int)(pointSize), (C.int)(weight), &outptr_QFont)
	ret := newQFont(outptr_QFont)
	ret.isSubclass = true
	return ret
}
...
func NewQFont11(families []string, pointSize int, weight int, italic bool) *QFont {
	...
	C.QFont_new11(families_ma, (C.int)(pointSize), (C.int)(weight), (C.bool)(italic), &outptr_QFont)
	ret := newQFont(outptr_QFont)
	ret.isSubclass = true
	return ret
}

...
QModelIndex* QStringListModel_virtualbase_parent(const void* self, QModelIndex* child);
bool QStringListModel_override_virtual_columnCount(void* self, intptr_t slot);
int QStringListModel_virtualbase_columnCount(const void* self, QModelIndex* parent);

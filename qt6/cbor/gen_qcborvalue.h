...
bool QCborValueConstRef_IsSimpleTypeWithSt(const QCborValueConstRef* self, unsigned char st);
unsigned char QCborValueConstRef_ToSimpleType(const QCborValueConstRef* self);
unsigned long long QCborValueConstRef_Tag(const QCborValueConstRef* self);
...
unsigned char QCborValueConstRef_ToSimpleType1(const QCborValueConstRef* self, unsigned char defaultValue);
unsigned long long QCborValueConstRef_Tag1(const QCborValueConstRef* self, unsigned long long defaultValue);
...
unsigned char QCborValueRef_ToSimpleType(const QCborValueRef* self);
...
unsigned char QCborValueRef_ToSimpleType1(const QCborValueRef* self, unsigned char defaultValue);

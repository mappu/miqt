...
func (this *QStringView) ConstData() *QChar {
	return UnsafeNewQChar(unsafe.Pointer(C.QStringView_ConstData(this.h)))
}
...
func (this *QStringView) ConstBegin() *QChar {
	return UnsafeNewQChar(unsafe.Pointer(C.QStringView_ConstBegin(this.h)))
}

func (this *QStringView) ConstEnd() *QChar {
	return UnsafeNewQChar(unsafe.Pointer(C.QStringView_ConstEnd(this.h)))
}
...
func (this *QStringView) First2() *QChar {
	_ret := C.QStringView_First2(this.h)
	_goptr := newQChar(_ret)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QStringView) Last2() *QChar {
	_ret := C.QStringView_Last2(this.h)
	_goptr := newQChar(_ret)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

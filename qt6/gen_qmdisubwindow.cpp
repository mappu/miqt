...
QSize* miqt_exec_callback_QMdiSubWindow_SizeHint(void*, intptr_t);
QSize* miqt_exec_callback_QMdiSubWindow_MinimumSizeHint(void*, intptr_t);
bool miqt_exec_callback_QMdiSubWindow_EventFilter(void*, intptr_t, QObject*, QEvent*);
bool miqt_exec_callback_QMdiSubWindow_Event(void*, intptr_t, QEvent*);
void miqt_exec_callback_QMdiSubWindow_ShowEvent(void*, intptr_t, QShowEvent*);
void miqt_exec_callback_QMdiSubWindow_HideEvent(void*, intptr_t, QHideEvent*);
void miqt_exec_callback_QMdiSubWindow_ChangeEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QMdiSubWindow_CloseEvent(void*, intptr_t, QCloseEvent*);
void miqt_exec_callback_QMdiSubWindow_LeaveEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QMdiSubWindow_ResizeEvent(void*, intptr_t, QResizeEvent*);
void miqt_exec_callback_QMdiSubWindow_TimerEvent(void*, intptr_t, QTimerEvent*);
void miqt_exec_callback_QMdiSubWindow_MoveEvent(void*, intptr_t, QMoveEvent*);
void miqt_exec_callback_QMdiSubWindow_PaintEvent(void*, intptr_t, QPaintEvent*);
void miqt_exec_callback_QMdiSubWindow_MousePressEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QMdiSubWindow_MouseDoubleClickEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QMdiSubWindow_MouseReleaseEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QMdiSubWindow_MouseMoveEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QMdiSubWindow_KeyPressEvent(void*, intptr_t, QKeyEvent*);
void miqt_exec_callback_QMdiSubWindow_ContextMenuEvent(void*, intptr_t, QContextMenuEvent*);
void miqt_exec_callback_QMdiSubWindow_FocusInEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QMdiSubWindow_FocusOutEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QMdiSubWindow_ChildEvent(void*, intptr_t, QChildEvent*);
int miqt_exec_callback_QMdiSubWindow_DevType(void*, intptr_t);
void miqt_exec_callback_QMdiSubWindow_SetVisible(void*, intptr_t, bool);
int miqt_exec_callback_QMdiSubWindow_HeightForWidth(void*, intptr_t, int);
bool miqt_exec_callback_QMdiSubWindow_HasHeightForWidth(void*, intptr_t);
QPaintEngine* miqt_exec_callback_QMdiSubWindow_PaintEngine(void*, intptr_t);
void miqt_exec_callback_QMdiSubWindow_WheelEvent(void*, intptr_t, QWheelEvent*);
void miqt_exec_callback_QMdiSubWindow_KeyReleaseEvent(void*, intptr_t, QKeyEvent*);
void miqt_exec_callback_QMdiSubWindow_EnterEvent(void*, intptr_t, QEnterEvent*);
void miqt_exec_callback_QMdiSubWindow_TabletEvent(void*, intptr_t, QTabletEvent*);
void miqt_exec_callback_QMdiSubWindow_ActionEvent(void*, intptr_t, QActionEvent*);
void miqt_exec_callback_QMdiSubWindow_DragEnterEvent(void*, intptr_t, QDragEnterEvent*);
void miqt_exec_callback_QMdiSubWindow_DragMoveEvent(void*, intptr_t, QDragMoveEvent*);
void miqt_exec_callback_QMdiSubWindow_DragLeaveEvent(void*, intptr_t, QDragLeaveEvent*);
void miqt_exec_callback_QMdiSubWindow_DropEvent(void*, intptr_t, QDropEvent*);
bool miqt_exec_callback_QMdiSubWindow_NativeEvent(void*, intptr_t, struct miqt_string, void*, intptr_t*);
int miqt_exec_callback_QMdiSubWindow_Metric(void*, intptr_t, int);
void miqt_exec_callback_QMdiSubWindow_InitPainter(void*, intptr_t, QPainter*);
QPaintDevice* miqt_exec_callback_QMdiSubWindow_Redirected(void*, intptr_t, QPoint*);
QPainter* miqt_exec_callback_QMdiSubWindow_SharedPainter(void*, intptr_t);

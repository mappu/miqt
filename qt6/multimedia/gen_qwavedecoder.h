...
long long QWaveDecoder_virtualbase_readData(void* self, char* data, long long maxlen);
...
long long QWaveDecoder_virtualbase_writeData(void* self, const char* data, long long len);

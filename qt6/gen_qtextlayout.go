...
func NewQTextLayout__FormatRange(param1 *QTextLayout__FormatRange) *QTextLayout__FormatRange {
	var outptr_QTextLayout__FormatRange *C.QTextLayout__FormatRange = nil

	C.QTextLayout__FormatRange_new(param1.cPointer(), &outptr_QTextLayout__FormatRange)
	ret := newQTextLayout__FormatRange(outptr_QTextLayout__FormatRange)
	ret.isSubclass = true
	return ret
}

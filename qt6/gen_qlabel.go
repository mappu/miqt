...
func (this *QLabel) Pixmap(param1 ReturnByValueConstant) *QPixmap {
	_goptr := newQPixmap(C.QLabel_Pixmap(this.h, (C.int)(param1)), nil)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QLabel) Pixmap2() *QPixmap {
	_goptr := newQPixmap(C.QLabel_Pixmap2(this.h), nil)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QLabel) Picture(param1 ReturnByValueConstant) *QPicture {
	_goptr := newQPicture(C.QLabel_Picture(this.h, (C.int)(param1)), nil)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QLabel) Picture2() *QPicture {
	_goptr := newQPicture(C.QLabel_Picture2(this.h), nil)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

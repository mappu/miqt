...
func newQDebug(h *C.QDebug) *QDebug {
	...
	return &QDebug{h: h, QIODeviceBase: UnsafeNewQIODeviceBase(unsafe.Pointer(h))}
}
...
func (this *QDebug) OperatorShiftLeftWithQByteArrayView(t QByteArrayView) *QDebug {
	return UnsafeNewQDebug(unsafe.Pointer(C.QDebug_OperatorShiftLeftWithQByteArrayView(this.h, t.cPointer())))
}

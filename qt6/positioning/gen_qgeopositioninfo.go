...
const (
	...
	QGeoPositionInfo__DirectionAccuracy  QGeoPositionInfo__Attribute = 6
)
...
func NewQGeoPositionInfo2(coordinate *QGeoCoordinate, updateTime *qt6.QDateTime) *QGeoPositionInfo {
...
func (this *QGeoPositionInfo) Swap(other *QGeoPositionInfo) {
	C.QGeoPositionInfo_swap(this.h, other.cPointer())
}
...
func (this *QGeoPositionInfo) SetTimestamp(timestamp *qt6.QDateTime) {
	C.QGeoPositionInfo_setTimestamp(this.h, (*C.QDateTime)(timestamp.UnsafePointer()))
}

func (this *QGeoPositionInfo) Timestamp() *qt6.QDateTime {
	_goptr := qt6.UnsafeNewQDateTime(unsafe.Pointer(C.QGeoPositionInfo_timestamp(this.h)))
...
func (this *QGeoPositionInfo) Detach() {
	C.QGeoPositionInfo_detach(this.h)
}

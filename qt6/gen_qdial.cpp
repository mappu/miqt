...
int miqt_exec_callback_QDial_DevType(void*, intptr_t);
void miqt_exec_callback_QDial_SetVisible(void*, intptr_t, bool);
int miqt_exec_callback_QDial_HeightForWidth(void*, intptr_t, int);
bool miqt_exec_callback_QDial_HasHeightForWidth(void*, intptr_t);
QPaintEngine* miqt_exec_callback_QDial_PaintEngine(void*, intptr_t);
void miqt_exec_callback_QDial_MouseDoubleClickEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QDial_KeyReleaseEvent(void*, intptr_t, QKeyEvent*);
void miqt_exec_callback_QDial_FocusInEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QDial_FocusOutEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QDial_EnterEvent(void*, intptr_t, QEnterEvent*);
void miqt_exec_callback_QDial_LeaveEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QDial_MoveEvent(void*, intptr_t, QMoveEvent*);
void miqt_exec_callback_QDial_CloseEvent(void*, intptr_t, QCloseEvent*);
void miqt_exec_callback_QDial_ContextMenuEvent(void*, intptr_t, QContextMenuEvent*);
void miqt_exec_callback_QDial_TabletEvent(void*, intptr_t, QTabletEvent*);
void miqt_exec_callback_QDial_ActionEvent(void*, intptr_t, QActionEvent*);
void miqt_exec_callback_QDial_DragEnterEvent(void*, intptr_t, QDragEnterEvent*);
void miqt_exec_callback_QDial_DragMoveEvent(void*, intptr_t, QDragMoveEvent*);
void miqt_exec_callback_QDial_DragLeaveEvent(void*, intptr_t, QDragLeaveEvent*);
void miqt_exec_callback_QDial_DropEvent(void*, intptr_t, QDropEvent*);
void miqt_exec_callback_QDial_ShowEvent(void*, intptr_t, QShowEvent*);
void miqt_exec_callback_QDial_HideEvent(void*, intptr_t, QHideEvent*);
bool miqt_exec_callback_QDial_NativeEvent(void*, intptr_t, struct miqt_string, void*, intptr_t*);
int miqt_exec_callback_QDial_Metric(void*, intptr_t, int);
void miqt_exec_callback_QDial_InitPainter(void*, intptr_t, QPainter*);
QPaintDevice* miqt_exec_callback_QDial_Redirected(void*, intptr_t, QPoint*);
QPainter* miqt_exec_callback_QDial_SharedPainter(void*, intptr_t);
void miqt_exec_callback_QDial_InputMethodEvent(void*, intptr_t, QInputMethodEvent*);
QVariant* miqt_exec_callback_QDial_InputMethodQuery(void*, intptr_t, int);
bool miqt_exec_callback_QDial_FocusNextPrevChild(void*, intptr_t, bool);
bool miqt_exec_callback_QDial_EventFilter(void*, intptr_t, QObject*, QEvent*);
void miqt_exec_callback_QDial_ChildEvent(void*, intptr_t, QChildEvent*);
void miqt_exec_callback_QDial_CustomEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QDial_ConnectNotify(void*, intptr_t, QMetaMethod*);
void miqt_exec_callback_QDial_DisconnectNotify(void*, intptr_t, QMetaMethod*);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QDial_DevType(const_cast<MiqtVirtualQDial*>(this), handle__DevType);
	...
	virtual int heightForWidth(int param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QDial_HeightForWidth(const_cast<MiqtVirtualQDial*>(this), handle__HeightForWidth, sigval1);
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QDial_HasHeightForWidth(const_cast<MiqtVirtualQDial*>(this), handle__HasHeightForWidth);
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QDial_PaintEngine(const_cast<MiqtVirtualQDial*>(this), handle__PaintEngine);
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QDial_Metric(const_cast<MiqtVirtualQDial*>(this), handle__Metric, sigval1);
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QDial_InitPainter(const_cast<MiqtVirtualQDial*>(this), handle__InitPainter, sigval1);
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QDial_Redirected(const_cast<MiqtVirtualQDial*>(this), handle__Redirected, sigval1);
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QDial_SharedPainter(const_cast<MiqtVirtualQDial*>(this), handle__SharedPainter);
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		QVariant* callback_return_value = miqt_exec_callback_QDial_InputMethodQuery(const_cast<MiqtVirtualQDial*>(this), handle__InputMethodQuery, sigval1);

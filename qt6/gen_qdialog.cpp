...
void miqt_exec_callback_QDialog_SetVisible(void*, intptr_t, bool);
QSize* miqt_exec_callback_QDialog_SizeHint(void*, intptr_t);
QSize* miqt_exec_callback_QDialog_MinimumSizeHint(void*, intptr_t);
void miqt_exec_callback_QDialog_Open(void*, intptr_t);
int miqt_exec_callback_QDialog_Exec(void*, intptr_t);
void miqt_exec_callback_QDialog_Done(void*, intptr_t, int);
void miqt_exec_callback_QDialog_Accept(void*, intptr_t);
void miqt_exec_callback_QDialog_Reject(void*, intptr_t);
void miqt_exec_callback_QDialog_KeyPressEvent(void*, intptr_t, QKeyEvent*);
void miqt_exec_callback_QDialog_CloseEvent(void*, intptr_t, QCloseEvent*);
void miqt_exec_callback_QDialog_ShowEvent(void*, intptr_t, QShowEvent*);
void miqt_exec_callback_QDialog_ResizeEvent(void*, intptr_t, QResizeEvent*);
void miqt_exec_callback_QDialog_ContextMenuEvent(void*, intptr_t, QContextMenuEvent*);
bool miqt_exec_callback_QDialog_EventFilter(void*, intptr_t, QObject*, QEvent*);
int miqt_exec_callback_QDialog_DevType(void*, intptr_t);
int miqt_exec_callback_QDialog_HeightForWidth(void*, intptr_t, int);
bool miqt_exec_callback_QDialog_HasHeightForWidth(void*, intptr_t);
QPaintEngine* miqt_exec_callback_QDialog_PaintEngine(void*, intptr_t);
bool miqt_exec_callback_QDialog_Event(void*, intptr_t, QEvent*);
void miqt_exec_callback_QDialog_MousePressEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QDialog_MouseReleaseEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QDialog_MouseDoubleClickEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QDialog_MouseMoveEvent(void*, intptr_t, QMouseEvent*);
void miqt_exec_callback_QDialog_WheelEvent(void*, intptr_t, QWheelEvent*);
void miqt_exec_callback_QDialog_KeyReleaseEvent(void*, intptr_t, QKeyEvent*);
void miqt_exec_callback_QDialog_FocusInEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QDialog_FocusOutEvent(void*, intptr_t, QFocusEvent*);
void miqt_exec_callback_QDialog_EnterEvent(void*, intptr_t, QEnterEvent*);
void miqt_exec_callback_QDialog_LeaveEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QDialog_PaintEvent(void*, intptr_t, QPaintEvent*);
void miqt_exec_callback_QDialog_MoveEvent(void*, intptr_t, QMoveEvent*);
void miqt_exec_callback_QDialog_TabletEvent(void*, intptr_t, QTabletEvent*);
void miqt_exec_callback_QDialog_ActionEvent(void*, intptr_t, QActionEvent*);
void miqt_exec_callback_QDialog_DragEnterEvent(void*, intptr_t, QDragEnterEvent*);
void miqt_exec_callback_QDialog_DragMoveEvent(void*, intptr_t, QDragMoveEvent*);
void miqt_exec_callback_QDialog_DragLeaveEvent(void*, intptr_t, QDragLeaveEvent*);
void miqt_exec_callback_QDialog_DropEvent(void*, intptr_t, QDropEvent*);
void miqt_exec_callback_QDialog_HideEvent(void*, intptr_t, QHideEvent*);
bool miqt_exec_callback_QDialog_NativeEvent(void*, intptr_t, struct miqt_string, void*, intptr_t*);
void miqt_exec_callback_QDialog_ChangeEvent(void*, intptr_t, QEvent*);
int miqt_exec_callback_QDialog_Metric(void*, intptr_t, int);
void miqt_exec_callback_QDialog_InitPainter(void*, intptr_t, QPainter*);
QPaintDevice* miqt_exec_callback_QDialog_Redirected(void*, intptr_t, QPoint*);
QPainter* miqt_exec_callback_QDialog_SharedPainter(void*, intptr_t);
void miqt_exec_callback_QDialog_InputMethodEvent(void*, intptr_t, QInputMethodEvent*);
QVariant* miqt_exec_callback_QDialog_InputMethodQuery(void*, intptr_t, int);
bool miqt_exec_callback_QDialog_FocusNextPrevChild(void*, intptr_t, bool);
void miqt_exec_callback_QDialog_TimerEvent(void*, intptr_t, QTimerEvent*);
void miqt_exec_callback_QDialog_ChildEvent(void*, intptr_t, QChildEvent*);
void miqt_exec_callback_QDialog_CustomEvent(void*, intptr_t, QEvent*);
void miqt_exec_callback_QDialog_ConnectNotify(void*, intptr_t, QMetaMethod*);
void miqt_exec_callback_QDialog_DisconnectNotify(void*, intptr_t, QMetaMethod*);
#ifdef __cplusplus
} /* extern C */
#endif

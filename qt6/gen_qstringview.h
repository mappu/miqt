...
long long QStringView_Size(const QStringView* self);
QChar* QStringView_Data(const QStringView* self);
QChar* QStringView_ConstData(const QStringView* self);
QChar* QStringView_OperatorSubscript(const QStringView* self, long long n);
...
QChar* QStringView_At(const QStringView* self, long long n);
void QStringView_Truncate(QStringView* self, long long n);
void QStringView_Chop(QStringView* self, long long n);
...
long long QStringView_IndexOf(const QStringView* self, QChar* c);
bool QStringView_Contains(const QStringView* self, QChar* c);
long long QStringView_Count(const QStringView* self, QChar* c);
long long QStringView_LastIndexOf(const QStringView* self, QChar* c);
long long QStringView_LastIndexOf2(const QStringView* self, QChar* c, long long from);
long long QStringView_IndexOfWithRe(const QStringView* self, QRegularExpression* re);
long long QStringView_LastIndexOf5(const QStringView* self, QRegularExpression* re, long long from);
bool QStringView_ContainsWithRe(const QStringView* self, QRegularExpression* re);
long long QStringView_CountWithRe(const QStringView* self, QRegularExpression* re);
...
long long QStringView_Length(const QStringView* self);
QChar* QStringView_First2(const QStringView* self);
QChar* QStringView_Last2(const QStringView* self);
long long QStringView_IndexOf2(const QStringView* self, QChar* c, long long from);
long long QStringView_IndexOf3(const QStringView* self, QChar* c, long long from, int cs);
bool QStringView_Contains2(const QStringView* self, QChar* c, int cs);
long long QStringView_Count2(const QStringView* self, QChar* c, int cs);
long long QStringView_LastIndexOf22(const QStringView* self, QChar* c, int cs);
long long QStringView_LastIndexOf32(const QStringView* self, QChar* c, long long from, int cs);
long long QStringView_IndexOf24(const QStringView* self, QRegularExpression* re, long long from);
long long QStringView_IndexOf34(const QStringView* self, QRegularExpression* re, long long from, QRegularExpressionMatch* rmatch);
long long QStringView_LastIndexOf35(const QStringView* self, QRegularExpression* re, long long from, QRegularExpressionMatch* rmatch);

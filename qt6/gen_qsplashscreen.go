...
func NewQSplashScreen5(screen *QScreen, pixmap *QPixmap) *QSplashScreen {
	ret := C.QSplashScreen_new5(screen.cPointer(), pixmap.cPointer())
	return newQSplashScreen(ret)
}
...
func NewQSplashScreen6(screen *QScreen, pixmap *QPixmap, f WindowType) *QSplashScreen {
	ret := C.QSplashScreen_new6(screen.cPointer(), pixmap.cPointer(), (C.int)(f))
	return newQSplashScreen(ret)
}

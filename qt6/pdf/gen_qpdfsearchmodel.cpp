...
struct miqt_array /* of struct miqt_string */  QPdfSearchModel_virtualbase_mimeTypes(const void* self) {
	QList<QString> _ret = static_cast<const MiqtVirtualQPdfSearchModel*>(self)->QPdfSearchModel::mimeTypes();
	// Convert QList<> from C++ memory to manually-managed C memory
...
struct miqt_array /* of QModelIndex* */  QPdfSearchModel_virtualbase_match(const void* self, QModelIndex* start, int role, QVariant* value, int hits, int flags) {
	QList<QModelIndex> _ret = static_cast<const MiqtVirtualQPdfSearchModel*>(self)->QPdfSearchModel::match(*start, static_cast<int>(role), *value, static_cast<int>(hits), static_cast<Qt::MatchFlags>(flags));
	// Convert QList<> from C++ memory to manually-managed C memory

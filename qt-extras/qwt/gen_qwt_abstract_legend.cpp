...
public:
	...
	virtual void renderLegend(QPainter* painter, const QRectF& rect, bool fillBackground) const override {
		...
		miqt_exec_callback_QwtAbstractLegend_renderLegend(this, handle__renderLegend, sigval1, sigval2, sigval3);
	...
	virtual bool isEmpty() const override {
		...
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_isEmpty(this, handle__isEmpty);
	...
	virtual int scrollExtent(Qt::Orientation param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QwtAbstractLegend_scrollExtent(this, handle__scrollExtent, sigval1);
	...
	virtual void updateLegend(const QVariant& itemInfo, const QList<QwtLegendData>& data) override {
		...
		miqt_exec_callback_QwtAbstractLegend_updateLegend(this, handle__updateLegend, sigval1, sigval2);
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QwtAbstractLegend_sizeHint(this, handle__sizeHint);
		return *callback_return_value;
	}
	...
	virtual bool event(QEvent* e) override {
		...
		QEvent* sigval1 = e;
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_event(this, handle__event, sigval1);
		return callback_return_value;
	}
	...
	virtual void paintEvent(QPaintEvent* param1) override {
		...
		miqt_exec_callback_QwtAbstractLegend_paintEvent(this, handle__paintEvent, sigval1);
	...
	virtual void changeEvent(QEvent* param1) override {
		...
		miqt_exec_callback_QwtAbstractLegend_changeEvent(this, handle__changeEvent, sigval1);
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QwtAbstractLegend_devType(this, handle__devType);
		return static_cast<int>(callback_return_value);
	}
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QwtAbstractLegend_setVisible(this, handle__setVisible, sigval1);
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QwtAbstractLegend_minimumSizeHint(this, handle__minimumSizeHint);
		return *callback_return_value;
	}
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QwtAbstractLegend_heightForWidth(this, handle__heightForWidth, sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_hasHeightForWidth(this, handle__hasHeightForWidth);
		return callback_return_value;
	}
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QwtAbstractLegend_paintEngine(this, handle__paintEngine);
		return callback_return_value;
	}
	...
	virtual void mousePressEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_mousePressEvent(this, handle__mousePressEvent, sigval1);
	...
	virtual void mouseReleaseEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_mouseReleaseEvent(this, handle__mouseReleaseEvent, sigval1);
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent, sigval1);
	...
	virtual void mouseMoveEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_mouseMoveEvent(this, handle__mouseMoveEvent, sigval1);
	...
	virtual void wheelEvent(QWheelEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_wheelEvent(this, handle__wheelEvent, sigval1);
	...
	virtual void keyPressEvent(QKeyEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_keyPressEvent(this, handle__keyPressEvent, sigval1);
	...
	virtual void keyReleaseEvent(QKeyEvent* event) override {
		...
		QKeyEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_keyReleaseEvent(this, handle__keyReleaseEvent, sigval1);
	...
	virtual void focusInEvent(QFocusEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_focusInEvent(this, handle__focusInEvent, sigval1);
	...
	virtual void focusOutEvent(QFocusEvent* event) override {
		...
		QFocusEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_focusOutEvent(this, handle__focusOutEvent, sigval1);
	...
	virtual void enterEvent(QEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_enterEvent(this, handle__enterEvent, sigval1);
	...
	virtual void leaveEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_leaveEvent(this, handle__leaveEvent, sigval1);
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_moveEvent(this, handle__moveEvent, sigval1);
	...
	virtual void resizeEvent(QResizeEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_resizeEvent(this, handle__resizeEvent, sigval1);
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_closeEvent(this, handle__closeEvent, sigval1);
	...
	virtual void contextMenuEvent(QContextMenuEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_contextMenuEvent(this, handle__contextMenuEvent, sigval1);
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_tabletEvent(this, handle__tabletEvent, sigval1);
	...
	virtual void actionEvent(QActionEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_actionEvent(this, handle__actionEvent, sigval1);
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_dragEnterEvent(this, handle__dragEnterEvent, sigval1);
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_dragMoveEvent(this, handle__dragMoveEvent, sigval1);
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_dragLeaveEvent(this, handle__dragLeaveEvent, sigval1);
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_dropEvent(this, handle__dropEvent, sigval1);
	...
	virtual void showEvent(QShowEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_showEvent(this, handle__showEvent, sigval1);
	...
	virtual void hideEvent(QHideEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_hideEvent(this, handle__hideEvent, sigval1);
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, long* result) override {
		...
		long* sigval3 = result;
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_nativeEvent(this, handle__nativeEvent, sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		int callback_return_value = miqt_exec_callback_QwtAbstractLegend_metric(this, handle__metric, sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		QPainter* sigval1 = painter;
		miqt_exec_callback_QwtAbstractLegend_initPainter(this, handle__initPainter, sigval1);
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QwtAbstractLegend_redirected(this, handle__redirected, sigval1);
		return callback_return_value;
	}
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QwtAbstractLegend_sharedPainter(this, handle__sharedPainter);
		return callback_return_value;
	}
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QwtAbstractLegend_inputMethodEvent(this, handle__inputMethodEvent, sigval1);
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		QVariant* callback_return_value = miqt_exec_callback_QwtAbstractLegend_inputMethodQuery(this, handle__inputMethodQuery, sigval1);
		return *callback_return_value;
	}
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_focusNextPrevChild(this, handle__focusNextPrevChild, sigval1);
		return callback_return_value;
	}
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QwtAbstractLegend_eventFilter(this, handle__eventFilter, sigval1, sigval2);
		return callback_return_value;
	}
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_timerEvent(this, handle__timerEvent, sigval1);
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QwtAbstractLegend_childEvent(this, handle__childEvent, sigval1);
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QwtAbstractLegend_customEvent(this, handle__customEvent, sigval1);
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QwtAbstractLegend_connectNotify(this, handle__connectNotify, sigval1);
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QwtAbstractLegend_disconnectNotify(this, handle__disconnectNotify, sigval1);

...
public:
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QwtSlider_sizeHint(this, handle__sizeHint);
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QwtSlider_minimumSizeHint(this, handle__minimumSizeHint);
		return *callback_return_value;
	}
	...
	virtual double scrolledTo(const QPoint& param1) const override {
		...
		double callback_return_value = miqt_exec_callback_QwtSlider_scrolledTo(this, handle__scrolledTo, sigval1);
	...
	virtual bool isScrollPosition(const QPoint& param1) const override {
		...
		// Cast returned reference into pointer
		QPoint* sigval1 = const_cast<QPoint*>(&param1_ret);
		bool callback_return_value = miqt_exec_callback_QwtSlider_isScrollPosition(this, handle__isScrollPosition, sigval1);
		return callback_return_value;
	}
	...
	virtual void drawSlider(QPainter* param1, const QRect& param2) const override {
		...
		miqt_exec_callback_QwtSlider_drawSlider(this, handle__drawSlider, sigval1, sigval2);
	...
	virtual void drawHandle(QPainter* param1, const QRect& param2, int pos) const override {
		...
		QRect* sigval2 = const_cast<QRect*>(&param2_ret);
		int sigval3 = pos;
		miqt_exec_callback_QwtSlider_drawHandle(this, handle__drawHandle, sigval1, sigval2, sigval3);
	...
	virtual void mousePressEvent(QMouseEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_mousePressEvent(this, handle__mousePressEvent, sigval1);
	...
	virtual void mouseReleaseEvent(QMouseEvent* param1) override {
		...
		QMouseEvent* sigval1 = param1;
		miqt_exec_callback_QwtSlider_mouseReleaseEvent(this, handle__mouseReleaseEvent, sigval1);
	...
	virtual void resizeEvent(QResizeEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_resizeEvent(this, handle__resizeEvent, sigval1);
	...
	virtual void paintEvent(QPaintEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_paintEvent(this, handle__paintEvent, sigval1);
	...
	virtual void changeEvent(QEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_changeEvent(this, handle__changeEvent, sigval1);
	...
	virtual void timerEvent(QTimerEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_timerEvent(this, handle__timerEvent, sigval1);
	...
	virtual void scaleChange() override {
		...
		miqt_exec_callback_QwtSlider_scaleChange(this, handle__scaleChange);
	...
	virtual void mouseMoveEvent(QMouseEvent* param1) override {
		...
		QMouseEvent* sigval1 = param1;
		miqt_exec_callback_QwtSlider_mouseMoveEvent(this, handle__mouseMoveEvent, sigval1);
	...
	virtual void keyPressEvent(QKeyEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_keyPressEvent(this, handle__keyPressEvent, sigval1);
	...
	virtual void wheelEvent(QWheelEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_wheelEvent(this, handle__wheelEvent, sigval1);
	...
	virtual void sliderChange() override {
		...
		miqt_exec_callback_QwtSlider_sliderChange(this, handle__sliderChange);
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QwtSlider_devType(this, handle__devType);
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QwtSlider_setVisible(this, handle__setVisible, sigval1);
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QwtSlider_heightForWidth(this, handle__heightForWidth, sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QwtSlider_hasHeightForWidth(this, handle__hasHeightForWidth);
		return callback_return_value;
	}
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QwtSlider_paintEngine(this, handle__paintEngine);
		return callback_return_value;
	}
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QwtSlider_event(this, handle__event, sigval1);
		return callback_return_value;
	}
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent, sigval1);
	...
	virtual void keyReleaseEvent(QKeyEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_keyReleaseEvent(this, handle__keyReleaseEvent, sigval1);
	...
	virtual void focusInEvent(QFocusEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_focusInEvent(this, handle__focusInEvent, sigval1);
	...
	virtual void focusOutEvent(QFocusEvent* event) override {
		...
		QFocusEvent* sigval1 = event;
		miqt_exec_callback_QwtSlider_focusOutEvent(this, handle__focusOutEvent, sigval1);
	...
	virtual void enterEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QwtSlider_enterEvent(this, handle__enterEvent, sigval1);
	...
	virtual void leaveEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QwtSlider_leaveEvent(this, handle__leaveEvent, sigval1);
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_moveEvent(this, handle__moveEvent, sigval1);
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_closeEvent(this, handle__closeEvent, sigval1);
	...
	virtual void contextMenuEvent(QContextMenuEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_contextMenuEvent(this, handle__contextMenuEvent, sigval1);
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_tabletEvent(this, handle__tabletEvent, sigval1);
	...
	virtual void actionEvent(QActionEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_actionEvent(this, handle__actionEvent, sigval1);
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_dragEnterEvent(this, handle__dragEnterEvent, sigval1);
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_dragMoveEvent(this, handle__dragMoveEvent, sigval1);
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_dragLeaveEvent(this, handle__dragLeaveEvent, sigval1);
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_dropEvent(this, handle__dropEvent, sigval1);
	...
	virtual void showEvent(QShowEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_showEvent(this, handle__showEvent, sigval1);
	...
	virtual void hideEvent(QHideEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_hideEvent(this, handle__hideEvent, sigval1);
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, long* result) override {
		...
		long* sigval3 = result;
		bool callback_return_value = miqt_exec_callback_QwtSlider_nativeEvent(this, handle__nativeEvent, sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QwtSlider_metric(this, handle__metric, sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QwtSlider_initPainter(this, handle__initPainter, sigval1);
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QwtSlider_redirected(this, handle__redirected, sigval1);
		return callback_return_value;
	}
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QwtSlider_sharedPainter(this, handle__sharedPainter);
		return callback_return_value;
	}
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QwtSlider_inputMethodEvent(this, handle__inputMethodEvent, sigval1);
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		QVariant* callback_return_value = miqt_exec_callback_QwtSlider_inputMethodQuery(this, handle__inputMethodQuery, sigval1);
		return *callback_return_value;
	}
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QwtSlider_focusNextPrevChild(this, handle__focusNextPrevChild, sigval1);
		return callback_return_value;
	}
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QwtSlider_eventFilter(this, handle__eventFilter, sigval1, sigval2);
		return callback_return_value;
	}
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QwtSlider_childEvent(this, handle__childEvent, sigval1);
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QwtSlider_customEvent(this, handle__customEvent, sigval1);
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QwtSlider_connectNotify(this, handle__connectNotify, sigval1);
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QwtSlider_disconnectNotify(this, handle__disconnectNotify, sigval1);
...
bool QwtSlider_override_virtual_drawSlider(void* self, intptr_t slot) {
	...
	self_cast->handle__drawSlider = slot;
	return true;
}
...
bool QwtSlider_override_virtual_drawHandle(void* self, intptr_t slot) {
	...
	self_cast->handle__drawHandle = slot;
	return true;
}

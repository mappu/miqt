...
func (this *QsciPrinter) PrintRange(qsb *QsciScintillaBase, painter *qt6.QPainter) int {
...
func (this *QsciPrinter) PrintRange3(qsb *QsciScintillaBase, painter *qt6.QPainter, from int) int {
	return (int)(C.QsciPrinter_PrintRange3(this.h, qsb.cPointer(), (*C.QPainter)(painter.UnsafePointer()), (C.int)(from)))
}

func (this *QsciPrinter) PrintRange4(qsb *QsciScintillaBase, painter *qt6.QPainter, from int, to int) int {

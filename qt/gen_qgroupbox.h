...
void QGroupBox_Tr(char* s, char** _out, int* _out_Strlen);
void QGroupBox_TrUtf8(char* s, char** _out, int* _out_Strlen);
...
void QGroupBox_Tr2(char* s, char* c, char** _out, int* _out_Strlen);
void QGroupBox_Tr3(char* s, char* c, int n, char** _out, int* _out_Strlen);
void QGroupBox_TrUtf82(char* s, char* c, char** _out, int* _out_Strlen);
void QGroupBox_TrUtf83(char* s, char* c, int n, char** _out, int* _out_Strlen);

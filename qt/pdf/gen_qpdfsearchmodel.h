...
QModelIndex* QPdfSearchModel_virtualbase_parent(const void* self, QModelIndex* child);
bool QPdfSearchModel_override_virtual_columnCount(void* self, intptr_t slot);
int QPdfSearchModel_virtualbase_columnCount(const void* self, QModelIndex* parent);

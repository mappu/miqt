...
func (this *QObjectData) PostedEvents() int {
	return (int)(C.QObjectData_postedEvents(this.h))
}

func (this *QObjectData) SetPostedEvents(postedEvents int) {
	C.QObjectData_setPostedEvents(this.h, (C.int)(postedEvents))
}

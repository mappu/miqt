...
QStyleOptionViewItem* QTableWidget_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const MiqtVirtualQTableWidget*)(self) )->MiqtVirtualQTableWidget::viewOptions());
...
bool QTableWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQTableWidget*)(self) )->MiqtVirtualQTableWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));

...
func NewQTimeZone6(zoneId []byte, offsetSeconds int, name string, abbreviation string, country QLocale__Country) *QTimeZone {
	...
	C.QTimeZone_new6(zoneId_alias, (C.int)(offsetSeconds), name_ms, abbreviation_ms, (C.int)(country), &outptr_QTimeZone)
	ret := newQTimeZone(outptr_QTimeZone)
	ret.isSubclass = true
	return ret
}
...
func NewQTimeZone7(zoneId []byte, offsetSeconds int, name string, abbreviation string, country QLocale__Country, comment string) *QTimeZone {
	...
	C.QTimeZone_new7(zoneId_alias, (C.int)(offsetSeconds), name_ms, abbreviation_ms, (C.int)(country), comment_ms, &outptr_QTimeZone)
	ret := newQTimeZone(outptr_QTimeZone)
	ret.isSubclass = true
	return ret
}

...
int QTextOption_Alignment(QTextOption* self) {
	Qt::Alignment ret = const_cast<const QTextOption*>(self)->alignment();
...
uintptr_t QTextOption_TextDirection(QTextOption* self) {
	Qt::LayoutDirection ret = const_cast<const QTextOption*>(self)->textDirection();
...
uintptr_t QTextOption_WrapMode(QTextOption* self) {
	QTextOption::WrapMode ret = const_cast<const QTextOption*>(self)->wrapMode();
	return static_cast<uintptr_t>(ret);
}
...
int QTextOption_Flags(QTextOption* self) {
	QTextOption::Flags ret = const_cast<const QTextOption*>(self)->flags();
	return static_cast<int>(ret);
}
...
double QTextOption_TabStop(QTextOption* self) {
	return const_cast<const QTextOption*>(self)->tabStop();
}
...
double QTextOption_TabStopDistance(QTextOption* self) {
	return const_cast<const QTextOption*>(self)->tabStopDistance();
}
...
void QTextOption_TabArray(QTextOption* self, double** _out, size_t* _out_len) {
	QList<double> ret = const_cast<const QTextOption*>(self)->tabArray();
...
void QTextOption_Tabs(QTextOption* self, QTextOption__Tab*** _out, size_t* _out_len) {
	QList<QTextOption::Tab> ret = const_cast<const QTextOption*>(self)->tabs();
...
bool QTextOption_UseDesignMetrics(QTextOption* self) {
	return const_cast<const QTextOption*>(self)->useDesignMetrics();
}
...
bool QTextOption__Tab_OperatorEqual(QTextOption__Tab* self, QTextOption__Tab* other) {
	return const_cast<const QTextOption::Tab*>(self)->operator==(*other);
}

bool QTextOption__Tab_OperatorNotEqual(QTextOption__Tab* self, QTextOption__Tab* other) {
	return const_cast<const QTextOption::Tab*>(self)->operator!=(*other);
}

...
QMatrix4x4* QMatrix4x4_new2(float* values) {
	return new QMatrix4x4(static_cast<float*>(values));
}

QMatrix4x4* QMatrix4x4_new3(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) {
...
QMatrix4x4* QMatrix4x4_new4(float* values, int cols, int rows) {
	return new QMatrix4x4(static_cast<float*>(values), static_cast<int>(cols), static_cast<int>(rows));
}

QMatrix4x4* QMatrix4x4_new5(QTransform* transform) {
	return new QMatrix4x4(*transform);
}

QMatrix4x4* QMatrix4x4_new6(QMatrix* matrix) {
...
QVector4D* QMatrix4x4_Column(QMatrix4x4* self, int index) {
	QVector4D ret = self->column(static_cast<int>(index));
...
QVector4D* QMatrix4x4_Row(QMatrix4x4* self, int index) {
	QVector4D ret = self->row(static_cast<int>(index));
	// Copy-construct value returned type into heap-allocated copy
	return static_cast<QVector4D*>(new QVector4D(ret));
}
...
float* QMatrix4x4_Data2(QMatrix4x4* self) {
	return (float*) self->data();
}

float* QMatrix4x4_ConstData(QMatrix4x4* self) {
	return (float*) self->constData();
}

...
QCborValueRef* QCborArray__Iterator_OperatorSubscript(QCborArray__Iterator* self, long long j) {
...
QCborValueRef* QCborArray__ConstIterator_OperatorSubscript(QCborArray__ConstIterator* self, long long j) {
	return new QCborValueRef(self->operator[]((qsizetype)(j)));
}

...
func newQStatusBar(h *C.QStatusBar, h_QWidget *C.QWidget, h_QObject *C.QObject, h_QPaintDevice *C.QPaintDevice) *QStatusBar {
	if h == nil {
		return nil
	}
...
func UnsafeNewQStatusBar(h unsafe.Pointer, h_QWidget unsafe.Pointer, h_QObject unsafe.Pointer, h_QPaintDevice unsafe.Pointer) *QStatusBar {
	if h == nil {
		return nil
	}

	return &QStatusBar{h: (*C.QStatusBar)(h),
...
func NewQStatusBar(parent *QWidget) *QStatusBar {
	var outptr_QStatusBar *C.QStatusBar = nil
	var outptr_QWidget *C.QWidget = nil
	var outptr_QObject *C.QObject = nil
	var outptr_QPaintDevice *C.QPaintDevice = nil

	C.QStatusBar_new(parent.cPointer(), &outptr_QStatusBar, &outptr_QWidget, &outptr_QObject, &outptr_QPaintDevice)
	ret := newQStatusBar(outptr_QStatusBar, outptr_QWidget, outptr_QObject, outptr_QPaintDevice)
	ret.isSubclass = true
	return ret
}
...
func NewQStatusBar2() *QStatusBar {
	...
	C.QStatusBar_new2(&outptr_QStatusBar, &outptr_QWidget, &outptr_QObject, &outptr_QPaintDevice)
	ret := newQStatusBar(outptr_QStatusBar, outptr_QWidget, outptr_QObject, outptr_QPaintDevice)
	ret.isSubclass = true
	return ret
}
...
func (this *QStatusBar) callVirtualBase_SizeHint() *QSize {
	...
	_ret := C.QStatusBar_virtualbase_SizeHint(unsafe.Pointer(this.h))
...
func (this *QStatusBar) callVirtualBase_MinimumSizeHint() *QSize {
	...
	_ret := C.QStatusBar_virtualbase_MinimumSizeHint(unsafe.Pointer(this.h))
	_goptr := newQSize(_ret)
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QStatusBar) callVirtualBase_PaintEngine() *QPaintEngine {
	...
	return UnsafeNewQPaintEngine(unsafe.Pointer(C.QStatusBar_virtualbase_PaintEngine(unsafe.Pointer(this.h))))
}
...
func (this *QStatusBar) callVirtualBase_Redirected(offset *QPoint) *QPaintDevice {
	...
	return UnsafeNewQPaintDevice(unsafe.Pointer(C.QStatusBar_virtualbase_Redirected(unsafe.Pointer(this.h), offset.cPointer())))
}
...
func (this *QStatusBar) callVirtualBase_SharedPainter() *QPainter {
	...
	return UnsafeNewQPainter(unsafe.Pointer(C.QStatusBar_virtualbase_SharedPainter(unsafe.Pointer(this.h))))
}
...
func (this *QStatusBar) callVirtualBase_InputMethodQuery(param1 InputMethodQuery) *QVariant {
	...
	_ret := C.QStatusBar_virtualbase_InputMethodQuery(unsafe.Pointer(this.h), (C.int)(param1))

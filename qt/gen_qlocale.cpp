...
struct miqt_string QLocale_ToCurrencyStringWithUnsignedshort(const QLocale* self, uint16_t param1) {
...
struct miqt_string QLocale_ToCurrencyStringWithUnsignedint(const QLocale* self, unsigned int param1) {

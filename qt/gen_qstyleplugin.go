...
func (this *QStylePlugin) MetaObject() *QMetaObject {
	ret := C.QStylePlugin_MetaObject(this.h)
...
func QStylePlugin_Tr(s string) string {
	...
	C.QStylePlugin_Tr(s_Cstring, &_out, &_out_Strlen)
...
func QStylePlugin_TrUtf8(s string) string {
	...
	var _out *C.char = nil
	var _out_Strlen C.int = 0
	C.QStylePlugin_TrUtf8(s_Cstring, &_out, &_out_Strlen)
	ret := C.GoStringN(_out, _out_Strlen)
	C.free(unsafe.Pointer(_out))
	return ret
}
...
func QStylePlugin_Tr2(s string, c string) string {
	...
	var _out *C.char = nil
	var _out_Strlen C.int = 0
	C.QStylePlugin_Tr2(s_Cstring, c_Cstring, &_out, &_out_Strlen)
	ret := C.GoStringN(_out, _out_Strlen)
	C.free(unsafe.Pointer(_out))
	return ret
}
...
func QStylePlugin_Tr3(s string, c string, n int) string {
	...
	var _out *C.char = nil
	var _out_Strlen C.int = 0
	C.QStylePlugin_Tr3(s_Cstring, c_Cstring, (C.int)(n), &_out, &_out_Strlen)
	ret := C.GoStringN(_out, _out_Strlen)
	C.free(unsafe.Pointer(_out))
	return ret
}
...
func QStylePlugin_TrUtf82(s string, c string) string {
	...
	var _out *C.char = nil
	var _out_Strlen C.int = 0
	C.QStylePlugin_TrUtf82(s_Cstring, c_Cstring, &_out, &_out_Strlen)
	ret := C.GoStringN(_out, _out_Strlen)
	C.free(unsafe.Pointer(_out))
	return ret
}
...
func QStylePlugin_TrUtf83(s string, c string, n int) string {
	...
	var _out *C.char = nil
	var _out_Strlen C.int = 0
	C.QStylePlugin_TrUtf83(s_Cstring, c_Cstring, (C.int)(n), &_out, &_out_Strlen)
	ret := C.GoStringN(_out, _out_Strlen)
	C.free(unsafe.Pointer(_out))
	return ret
}

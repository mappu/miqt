...
func NewQPrintPreviewWidget3(printer *QPrinter, parent *qt.QWidget) *QPrintPreviewWidget {
...
func NewQPrintPreviewWidget4(printer *QPrinter, parent *qt.QWidget, flags qt.WindowType) *QPrintPreviewWidget {
...
func NewQPrintPreviewWidget5(parent *qt.QWidget) *QPrintPreviewWidget {
...
func (this *QPrintPreviewWidget) Metacast(param1 string) unsafe.Pointer {
	...
	return C.QPrintPreviewWidget_Metacast(this.h, param1_Cstring)
}

...
func (this *QTcpSocket) callVirtualBase_SetSocketDescriptor(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool {
...
func (this *QTcpSocket) OnSetSocketDescriptor(slot func(super func(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool, socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}

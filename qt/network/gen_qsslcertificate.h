...
struct miqt_array QSslCertificate_FromPath(struct miqt_string path, int format, int syntax);
struct miqt_array QSslCertificate_FromPathWithPath(struct miqt_string path);

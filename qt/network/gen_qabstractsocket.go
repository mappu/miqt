...
func (this *QAbstractSocket) SetSocketDescriptor(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool {
...
func (this *QAbstractSocket) callVirtualBase_SetSocketDescriptor(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool {
...
func (this *QAbstractSocket) OnSetSocketDescriptor(slot func(super func(socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool, socketDescriptor int64, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool) {
	if !this.isSubclass {
		panic("miqt: can only override virtual methods for directly constructed types")
	}

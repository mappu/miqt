...
func newQAbstractSocket(h *C.QAbstractSocket) *QAbstractSocket {
	...
	return &QAbstractSocket{h: h, QIODevice: qt.UnsafeNewQIODevice(unsafe.Pointer(h))}
}
...
func (this *QAbstractSocket) ConnectToHost3(hostName string, port uint16, mode qt.QIODevice__OpenModeFlag) {
	hostName_ms := C.struct_miqt_string{}
	hostName_ms.data = C.CString(hostName)
	hostName_ms.len = C.size_t(len(hostName))
	defer C.free(unsafe.Pointer(hostName_ms.data))
...
func (this *QAbstractSocket) ConnectToHost4(hostName string, port uint16, mode qt.QIODevice__OpenModeFlag, protocol QAbstractSocket__NetworkLayerProtocol) {
	hostName_ms := C.struct_miqt_string{}
	hostName_ms.data = C.CString(hostName)
	hostName_ms.len = C.size_t(len(hostName))
	defer C.free(unsafe.Pointer(hostName_ms.data))
...
func (this *QAbstractSocket) ConnectToHost32(address *QHostAddress, port uint16, mode qt.QIODevice__OpenModeFlag) {
...
func (this *QAbstractSocket) SetSocketDescriptor3(socketDescriptor uintptr, state QAbstractSocket__SocketState, openMode qt.QIODevice__OpenModeFlag) bool {

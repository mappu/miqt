...
void QVideoWidget_override_virtual_MediaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQVideoWidget*>( (QVideoWidget*)(self) )->handle__MediaObject = slot;
}
...
void QVideoWidget_override_virtual_SetMediaObject(void* self, intptr_t slot) {
	dynamic_cast<MiqtVirtualQVideoWidget*>( (QVideoWidget*)(self) )->handle__SetMediaObject = slot;
}

...
QDirModel* QDirModel_new(struct miqt_array /* of struct miqt_string */  nameFilters, int filters, int sort) {
	...
	return new (std::nothrow) MiqtVirtualQDirModel(nameFilters_QStringList, static_cast<QDir::Filters>(filters), static_cast<QDir::SortFlags>(sort));
}
...
QDirModel* QDirModel_new3(struct miqt_array /* of struct miqt_string */  nameFilters, int filters, int sort, QObject* parent) {
	...
	return new (std::nothrow) MiqtVirtualQDirModel(nameFilters_QStringList, static_cast<QDir::Filters>(filters), static_cast<QDir::SortFlags>(sort), parent);
}
...
QMimeData* QDirModel_mimeData(const QDirModel* self, struct miqt_array /* of QModelIndex* */  indexes) {
	...
	return self->mimeData(indexes_QModelIndexList);
}
...
QMimeData* QDirModel_virtualbase_mimeData(const void* self, struct miqt_array /* of QModelIndex* */  indexes) {
	...
	return static_cast<const MiqtVirtualQDirModel*>(self)->QDirModel::mimeData(indexes_QModelIndexList);
}

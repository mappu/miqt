...
func newQStyleOptionTabV4(h *C.QStyleOptionTabV4, h_QStyleOptionTab *C.QStyleOptionTab, h_QStyleOption *C.QStyleOption) *QStyleOptionTabV4 {
	if h == nil {
		return nil
	}
	return &QStyleOptionTabV4{h: h,
		QStyleOptionTab: newQStyleOptionTab(h_QStyleOptionTab, h_QStyleOption)}
}

// UnsafeNewQStyleOptionTabV4 constructs the type using only unsafe pointers.
func UnsafeNewQStyleOptionTabV4(h unsafe.Pointer, h_QStyleOptionTab unsafe.Pointer, h_QStyleOption unsafe.Pointer) *QStyleOptionTabV4 {
	if h == nil {
		return nil
	}

	return &QStyleOptionTabV4{h: (*C.QStyleOptionTabV4)(h),
		QStyleOptionTab: UnsafeNewQStyleOptionTab(h_QStyleOptionTab, h_QStyleOption)}
}

// NewQStyleOptionTabV4 constructs a new QStyleOptionTabV4 object.
func NewQStyleOptionTabV4() *QStyleOptionTabV4 {
	var outptr_QStyleOptionTabV4 *C.QStyleOptionTabV4 = nil
	var outptr_QStyleOptionTab *C.QStyleOptionTab = nil
	var outptr_QStyleOption *C.QStyleOption = nil

	C.QStyleOptionTabV4_new(&outptr_QStyleOptionTabV4, &outptr_QStyleOptionTab, &outptr_QStyleOption)
	ret := newQStyleOptionTabV4(outptr_QStyleOptionTabV4, outptr_QStyleOptionTab, outptr_QStyleOption)
	ret.isSubclass = true
	return ret
}
...
func NewQStyleOptionTabV42(param1 *QStyleOptionTabV4) *QStyleOptionTabV4 {
	...
	C.QStyleOptionTabV4_new2(param1.cPointer(), &outptr_QStyleOptionTabV4, &outptr_QStyleOptionTab, &outptr_QStyleOption)
	ret := newQStyleOptionTabV4(outptr_QStyleOptionTabV4, outptr_QStyleOptionTab, outptr_QStyleOption)
	ret.isSubclass = true
	return ret
}
